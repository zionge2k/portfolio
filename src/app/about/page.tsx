  ...
  return (
    <div className="space-y-10">
      ...
      <section aria-label="프로필">
        <Prompt command="vim ~/about/profile.md" />
      ...
      <section aria-label="경력">
        <Prompt command="vim ~/about/career.md" />
        <div className="mt-4">
      ...
      <section aria-label="기술 스택">
        <Prompt command="vim ~/.config/tech-stack.yml" />
        <div className="mt-4">
      ...
      <section aria-label="학력">
        <Prompt command="vim ~/education/history.log" />
        <div className="mt-4">
      ...
      {/* Now */}
      <section aria-label="현재">
        <Prompt command="vim ~/status/now.md" />
        <div className="mt-4">
      ...
      <section aria-label="연락처">
        <Prompt command="vim ~/.ssh/contact.pub" />
        <div className="mt-4">
